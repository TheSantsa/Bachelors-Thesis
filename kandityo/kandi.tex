...
%% 
\thispagestyle{empty}
Taajuusmuuttajia käytetään yhä enenevissä määrin vaihtovirtasähkömoottoreiden ohjaukseen kaikilla teollisuudenaloilla ja erityisesti kaivosteollisuudessa \cite[s. 262]{Hakapää}. %%s. 262: taajuusmuuttajat 
...
\bibitem{MetsoHaastattelu}Veijo Väyrynen, sähkösuunnittelija. Juha Kenttälä, kehityspäällikkö. Metso Oy. Haastattelu, 5.12.2014. Tampere.
