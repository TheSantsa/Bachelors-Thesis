...
\\\\
Muuttuvista ympäristöolosuhteista ja liikkuvista työpisteistä johtuen kaivosalue on käyttöympäristönä haastava verrattuna esimerkiksi prosessiteollisuuteen.
\\\\
Tämän työn yhteydessä kaivosteollisuudella tarkoitetaan kaivosta ja sen välittömässä läheisyydessä tapahtuvaa malmin siirtoa ja käsittelyä. Tällä alueella tapahtuu suuri määrä erilaisia sähkömoottoreita vaativa toimintoja, 
\clearpage
