...
ympäristö rajoitta käyttöä blaablaa\\
ipluokat lämmintä derating.
\subsubsection{Lämpö}
...
\\\\
Etenkin syvissä kaivoksissa kallioperän lämpö on suurimpia kaivoksen sisäilman lämmittäjiä. Kallioperän lämpötila kasvaa noin 25-30c/km, joten jo kilometrin syvyisessä kaivoksessa lämpötila voi yltää 30-40c riippuen paikallisesta ilmastosta. \cite{maanlampo}
\\\\
Myös työkoneet tuottavat lämpöä etenkin jos käytetään dieselkäyttöisiä koneita?
\\\\
