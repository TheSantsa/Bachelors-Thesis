...
Kaivosteollisuus käsittää laajan joukon aliprosesseja, joissa kussakin käytetään siihen suunniteltuja koneita. Näitä kaivosalueella tapahtuvia malmin rikastamisen välivaiheita ovat louhiminen räjäyttämällä tai poraamalla, louheen siirto, murskaus ja rikastus. Polttoaineen hinnan kasvaessa kaivoksissa on siirrytty pääosin sähköä voimanaan käyttäviin koneisiin, mikä on luonut tarpeen sähkömoottorien tehokkaalle ohjaukselle taajuusmuuttajilla. Nykyään dieselkoneita käytetään lähinnä vain liikkuvassa kalustossa, mihin sähkönsiirto johdinta pitkin tai akuston avulla voi olla hankalaa tai epäkannattavaa.
\\\\
Tässä kappaleessa luodaan kuva kaivoksessa tapahtuvista sähkövoimaa vaativista prosesseista ja siitä miten taajuusmuuttajia hyödynnetään niissä. Kappale kuvaa sekä avolouhosten että maanalaisten kaivosten toimintaa, koska niihin sisältyy pitkälti samat malminkäsittelyn prosessit. Jotkut järjestelmät kuten kaivoksen tuuletus ovat luonnollisesti olennaisia vain maanalaisissa ympäristöissä.
\\\\ 
...
\subsection{Kaivoksen prosessit}
Kaivosprosessi koostuu useasta välivaiheesta, joissa maaperän malmi saadaan hyödynnettävään muotoon. Tähän ketjuun kuuluu kolme pääosaa, malmin louhiminen, hienonnus ja rikastus. Eri prosessien välillä malmi täytyy siirtää eri menetelmiä käyttäen ja malminsiirto onkin yksi merkittävä energiaa kuluttava prosessi itsessään.
\\\\
Malmi saadaan irti maaperästä räjäyttämällä tai louhimalla. Louhinnassa voidaan käyttää useita eri menetelmiä, mitkä riippuvat paljolti maaperän laadusta ja louhittavasta mineraalista metallista. L
%tähän nopea brief malmin matkasta kaivoksen sisältä tänne. 
